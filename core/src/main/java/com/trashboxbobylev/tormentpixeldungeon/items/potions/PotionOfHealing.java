...
import com.trashboxbobylev.tormentpixeldungeon.actors.buffs.Healing;
...
public class PotionOfHealing extends Potion {
	...
	public void apply( Hero hero ) {
		...
		Buff.affect( hero, Healing.class ).setHeal((int)(0.8f*hero.HT + 14 + (0.8f*hero.HT+14)*level()*1.5f), 0.333f, 0);
		cure( hero );
