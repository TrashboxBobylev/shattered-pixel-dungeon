...
import com.trashboxbobylev.tormentpixeldungeon.actors.blobs.VenomGas;
...
import com.trashboxbobylev.tormentpixeldungeon.sprites.GhostSprite;
...
import com.trashboxbobylev.tormentpixeldungeon.windows.IconTitle;
import com.trashboxbobylev.tormentpixeldungeon.windows.WndBag;
import com.trashboxbobylev.tormentpixeldungeon.windows.WndBlacksmith;
import com.trashboxbobylev.tormentpixeldungeon.windows.WndQuest;
...
public class DriedRose extends Artifact {
	...
	public static class GhostHero extends NPC {
		...
		public int drRoll() {
			int block = 0;
			if (rose != null && rose.armor != null){
				block += Random.NormalIntRange(0, rose.armor.DR());
			}
			if (rose != null && rose.weapon != null){
