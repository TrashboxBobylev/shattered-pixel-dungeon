...
import com.trashboxbobylev.tormentpixeldungeon.effects.ShadowBox;
...
public class Window extends Group implements Signal.Listener<Key> {
	...
	public static final int TITLE_COLOR = 0xB1CCE7;
	public static final int SHPX_COLOR = 0x69A3C3;
