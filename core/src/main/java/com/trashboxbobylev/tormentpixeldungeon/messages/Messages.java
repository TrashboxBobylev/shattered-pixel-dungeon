...
package com.trashboxbobylev.tormentpixeldungeon.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.trashboxbobylev.tormentpixeldungeon.messages.actors.actors",
			"com.trashboxbobylev.tormentpixeldungeon.messages.items.items",
			"com.trashboxbobylev.tormentpixeldungeon.messages.journal.journal",
			"com.trashboxbobylev.tormentpixeldungeon.messages.levels.levels",
			"com.trashboxbobylev.tormentpixeldungeon.messages.plants.plants",
			"com.trashboxbobylev.tormentpixeldungeon.messages.scenes.scenes",
			"com.trashboxbobylev.tormentpixeldungeon.messages.ui.ui",
			"com.trashboxbobylev.tormentpixeldungeon.messages.windows.windows",
			"com.trashboxbobylev.tormentpixeldungeon.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.trashboxbobylev.tormentpixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
